...
describe Lexiconomitron do
    ...
    it "reverse and remove 'T'" do
  		...
  		test_result = ["olleh", "sih", "a", "gnirob", "se"]
  		expect(test_obj).to eq(test_result)
  	end

  	 it "reverse and remove 'T'2" do
  		@superobject.shazam(%w[hello This a boring test]).should == %w[olleh sih a gnirob se]
